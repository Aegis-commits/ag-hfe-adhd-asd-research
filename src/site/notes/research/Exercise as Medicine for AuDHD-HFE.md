---
{"dg-publish":true,"permalink":"/research/exercise-as-medicine-for-au-dhd-hfe/","tags":["exercise","ADHD","autism","iron-metabolism","dopamine","BDNF","sleep","trichotillomania","gut-microbiome","executive-function"],"dg-note-properties":{"type":"research-review","status":"active","date":"2026-03-27","tags":["exercise","ADHD","autism","iron-metabolism","dopamine","BDNF","sleep","trichotillomania","gut-microbiome","executive-function"],"summary":"Comprehensive evidence review of exercise as medicine for AuDHD with HFE compound heterozygosity, trichotillomania, and fatigue","permalink":"obsidian/research/exercise-as-medicine-for-au-dhd-hfe-1"}}
---
...
**Related notes:** [[research/Copper-Iron-Dopamine Triangle\|Copper-Iron-Dopamine Triangle]] | [[research/Hepcidin and Brain Iron Regulation\|Hepcidin and Brain Iron Regulation]] | [[research/Iron and OCD-Spectrum Repetitive Behaviours\|Iron and OCD-Spectrum Repetitive Behaviours]] | [[research/Poor Sleep and AuDHD-HFE Interactions\|Poor Sleep and AuDHD-HFE Interactions]]
...
| Grade | Meaning |
|-------|---------|
| **A** | Strong: RCTs, meta-analyses, systematic reviews with consistent findings |
| **B** | Moderate: Well-designed cohort/observational studies, small RCTs, consistent narrative reviews |
| **C** | Limited: Case series, expert opinion, mechanistic/animal data, pilot studies |
| **D** | Very limited: Case reports, theoretical extrapolation, indirect evidence only |
...
|---------|-----------|------------|
| **Fatigue** | HFE iron overload, ADHD sleep disruption, Elvanse crash | Start with low-intensity; morning timing; short bouts (10-15 min) |
| **Autistic burnout** | Allostatic overload from masking + sensory demands | Reduce exercise demands during burnout; home-based options; no social demands |
| **Sensory issues** | Gym noise, lighting, smells, tactile (sweat/clothing) | Home exercise, outdoor walks, swimming (proprioceptive input), noise-cancelling headphones |
| **ADHD motivation** | Dopamine-driven novelty seeking, task initiation difficulty | Gamification, variety, exergaming, body-doubling, habit stacking with Elvanse onset |
| **Executive dysfunction** | Planning, sequencing, time blindness | Pre-set routines, minimal decision points, visual schedules, same-time daily |
| **Iron overload risk** | TSAT 60% -- vigorous exercise may increase oxidative stress | Moderate intensity preferred; ensure adequate antioxidant intake; monitor ferritin |
...
| Domain | Evidence Grade | Key Effect Size | Clinical Relevance |
|--------|---------------|-----------------|-------------------|
| Exercise + ADHD EF | **A** | SMD 0.42-0.84 | Strong adjunct to stimulant medication |
| Exercise + Autism | **B** | Qualitative/barriers | Must address sensory/social barriers |
| Exercise + Iron metabolism | **B** | Hepcidin up 3-6h post | Potentially therapeutic for HFE |
| Exercise + Dopamine/BDNF | **B** | 30-40% BDNF increase acute | Complements Elvanse mechanism |
| Exercise + Sleep | **A** | Improved latency + quality | Critical for AuDHD sleep issues |
| Exercise + Trich/BFRBs | **C-D** | Indirect via mood/anxiety | Adjunctive only; needs more RCTs |
| Exercise + Gut microbiome | **B** | Increased diversity + SCFA | Broad systemic anti-inflammatory |
| Practical tolerability | **B-C** | Barrier-specific | Home-based, structured, sensory-safe |
