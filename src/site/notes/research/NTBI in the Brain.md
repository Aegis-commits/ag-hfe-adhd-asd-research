---
{"dg-publish":true,"permalink":"/research/ntbi-in-the-brain/","tags":["NTBI","brain-iron","blood-brain-barrier","iron-toxicity","CSF","ZIP8","ZIP14"],"dg-note-properties":{"type":"research","status":"active","date":"2026-03-21","tags":["NTBI","brain-iron","blood-brain-barrier","iron-toxicity","CSF","ZIP8","ZIP14"],"summary":"NTBI can enter the brain via alternative transporters, bypassing normal iron regulation — CSF transferrin is 100% saturated with zero buffering capacity","permalink":"research/ntbi-in-the-brain"}}
---
...
The existing note on [[iron-metabolism/Iron Overload and NTBI\|Iron Overload and NTBI]] covers systemic NTBI. This note focuses specifically on whether and how NTBI reaches the brain, and what happens when it does.
...
For someone with [[genetics/HFE Compound Heterozygosity\|C282Y/H63D]] and [[iron-metabolism/Transferrin Saturation - Clinical Significance\|TSAT 60%]]:
...
- [[research/Hepcidin and Brain Iron Regulation\|Hepcidin and Brain Iron Regulation]]
