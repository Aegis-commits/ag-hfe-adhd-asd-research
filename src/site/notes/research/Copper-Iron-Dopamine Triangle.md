---
{"dg-publish":true,"permalink":"/research/copper-iron-dopamine-triangle/","tags":["copper","iron","dopamine","norepinephrine","ceruloplasmin","DBH","ATP7A","neurotransmitter"],"dg-note-properties":{"type":"research","status":"active","date":"2026-03-21","tags":["copper","iron","dopamine","norepinephrine","ceruloplasmin","DBH","ATP7A","neurotransmitter"],"summary":"The copper-iron-dopamine triangle — how copper, iron, and dopamine metabolism are biochemically inseparable, with clinical implications for ADHD","permalink":"research/copper-iron-dopamine-triangle"}}
---
...
The existing [[minerals/Copper-Zinc-Iron Interactions\|Copper-Zinc-Iron Interactions]] note covers absorption competition and the vicious cycle. This note goes deeper into the **neurobiochemical triangle** connecting copper, iron, and catecholamine synthesis in the brain.
...
See [[neurodevelopment/Iron-Dopamine-ADHD Axis\|Iron-Dopamine-ADHD Axis]] for full detail. In brief:
...
See [[iron-metabolism/Ceruloplasmin and Ferroxidase Activity\|Ceruloplasmin and Ferroxidase Activity]] for the cellular mechanism.
...
- This dopamine/norepinephrine imbalance could affect:
  ...
  - [[neurodevelopment/Elvanse and Mineral Metabolism\|Elvanse]] efficacy (lisdexamfetamine affects both systems)
